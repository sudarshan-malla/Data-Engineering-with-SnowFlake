...
-- Share data
create or replace view app_instance_schema.weather_hamburg_app as select * from shared_content_schema.weather_hamburg_app;

-- Create Streamlit app
create or replace streamlit app_instance_schema.streamlit from '/ui' main_file='streamlit.py';
...
grant SELECT on view app_instance_schema.weather_hamburg_app to application role app_instance_role;
